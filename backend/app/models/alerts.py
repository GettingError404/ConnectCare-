...
from sqlalchemy import String, ForeignKey, Index, DateTime, Boolean
...
class AlertRule(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    organization_id: Mapped[Optional[uuid.UUID]] = mapped_column(PGUUID(as_uuid=True), nullable=True, index=True)
